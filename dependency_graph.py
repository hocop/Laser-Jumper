...
def create_graph(folder, create_cluster, label_cluster, strict, ignore):
    """ Create a graph from a folder. """
    # Find nodes and clusters
    ignore = ignore.split(',')
    files = find_all_files(folder, ignore=ignore)
...
if __name__ == '__main__':
    ...
    graph = create_graph(args.folder, args.cluster, args.cluster_labels, args.strict, args.ignore)
